...
const messages = [
    "Tap dimana aja yaaa",
    "haii sayangg",
    "kamu lagi bete yaa gara gara akuu, yaudah nih hadiah buat kamu biar gak ngambek dipencet yaa",
    "coba pencet",
    "pencet lagi",
    "ayo sayangg semangat mencetnya",
    "janji ini terakhir",
    "serius",
    "ini",
    "terakhir",
    "tapi bohong hehe jangan marah yaa ayo pencet lagi",
    "aku tau pasti kamu kesal",
    "hmm",
    "yaudah deh",
    "padahal",
    "aku cuma mau bilang",
    "Beli donat isinya keju",
    "Udah deh sayang, maafin aku ya... I love you 😘",
    "aduhhh salting ehemm hehe",
